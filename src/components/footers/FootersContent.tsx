...
const FootersContent: React.FC<FootersContentProps> = ({ dataGlobal }) => {
    ...
    return (
        <div className="relative h-full overflow-hidden bg-secondary">
            {/* waves */}
            <picture className="absolute top-[-1px] z-10 rotate-180" style={{ right: '-100px', width: 'calc(100% + 100px)' }}>
                <img
            ...
            <div className="relative w-[85%] mx-auto h-full mt-16 md:mt-36 pt-10 pb-0 md:py-10">
                <div className="w-full h-full flex flex-col md:flex-row gap-5">
                    ...
                    <div className="w-full md:w-[27%] pt-3 md:pt-14 pl-0 md:pl-5">
                        ...
                        <div className="block bg-tertiary w-1/5 h-0.5 mt-5 mb-8 mx-auto md:mx-0"></div>
                        <ul>
                            ...
                            )}
                            {
                                dataPhone && dataPhone.length > 0 && dataPhone.slice(0, 2).map((phone, index) => (
                                    <li key={index} className="mb-5 text-white font-medium hover:text-tertiary transition-all duration-300 ease-in-out">
                                        <a
                                ...
                                dataGlobal.services.slice(0, 6).map((service, index) => (
                                    <li key={index} className="mb-5">
                                        <a
                                            ...
                                            className="text-white capitalize font-medium hover:text-tertiary"
                ...
                <div className="border-t border-tertiary mt-10 py-5 flex flex-col md:flex-row justify-between items-center">
                    {
                        !onePages && (
                ...
                <div className="fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center z-50">
                    <div className="bg-white p-4 rounded-lg relative">
                        <img
                            ...
                            loading="lazy"
                        />
                        <button onClick={() => setIsModalOpen(false)} className="absolute right-2 -top-14 md:-top-8 md:-right-8 px-4 py-2.5 font-bold bg-tertiary rounded-full text-white text-2xl">✕</button>
                    </div>
                </div>
            )}
