...
const AboutsBlocks: React.FC<AboutsBlocksProps> = ({ dataAbout,dbPhone }) => {
    ...
    return (
        <div className="relative w-full h-full">
            ...
            <div className="md:absolute right-0 -bottom-10 bg-secondary w-full  md:w-[60%]  flex items-center px-5 md:pr-0 md:pl-20 py-10 md:py-32">
                <div className="w-4/5 mx-auto md:ml-0 md:mr-auto h-full">
                    ...
                    <div className="flex flex-col md:flex-row justify-center items-center md:justify-start gap-10 py-5">
                        <ButtonContent_2 />
                        <ButtonContent_2  titleBtn="Call us now" linkBtn={`tel:+1${primaryPhone}`}/>
                    </div>
                </div>
            </div>
        </div>
