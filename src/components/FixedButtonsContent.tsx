            ...
            <div className="bg-tertiary rounded-tr-lg rounded-br-lg flex flex-col">
                {dataGlobal.widgets.btnWhatsapp && (
                    <button
                        ...
                        className="text-black text-center text-lg font-bold border-b border-gray-200 p-3 bg-transparent rounded-tr-lg hover:bg-green-600 transition-all duration-300 ease-in-out"
                ...
                }
                {
                    dataGlobal.widgets.counterVisit && (
                        <button
                            ...
                            className="text-black text-center text-lg font-bold  p-3 border-b border-gray-200 rounded-br-lg hover:bg-blue-600"
